...
<div>
	...
	<button class="btn" onclick={() => changeStatusSantri('hadir')}>Hadir</button>
	<button class="btn" onclick={() => changeStatusSantri('alfa')}>Alfa</button>
	<button class="btn" onclick={() => changeStatusSantri('sakit')}>Sakit</button>
	<button class="btn" onclick={() => changeStatusSantri('izin')}>Izin</button>
</div>
